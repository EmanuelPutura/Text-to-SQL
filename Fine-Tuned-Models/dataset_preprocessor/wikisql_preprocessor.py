...
class WikiSQLPreprocessor:
    def __init__(self, tokenizer):
        ...
        self.__train_data = self.__train_data.map(WikiSQLPreprocessor.__format_dataset, remove_columns=self.__train_data.column_names)
        self.__test_data = self.__test_data.map(WikiSQLPreprocessor.__format_dataset, remove_columns=self.__test_data.column_names)
